...
from Tacotron_TTS.util.infolog import log
  ...
  def initialize(self, inputs, input_lengths, mel_targets=None, linear_targets=None):
    ...
    with tf.variable_scope('inference') as scope:
      ...
      embedding_table = tf.get_variable(
        'embedding', [len(symbols.symbols_all), hp.embed_depth], dtype=tf.float32,
      ...
      log('Initialized Tacotron_TTS model. Dimensions: ')
