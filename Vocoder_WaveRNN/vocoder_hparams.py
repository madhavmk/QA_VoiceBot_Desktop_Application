...
ignore_tts = False  # original implementation was False
...
fft_bins = n_fft // 2 + 1
num_mels = 80
hop_length = 275                    # 12.5ms - in line with Tacotron_TTS 2 paper
...
peak_norm = True                   # Normalise to the peak of each wav file originally false
