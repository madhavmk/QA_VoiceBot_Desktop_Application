...
mixer.pre_init(10500, -16, 2, 2048)
mixer.init()
...
if tts_choice == 0:
    ...
    synthesizer.load('tacotron-models\\model.ckpt')
    model_load_end = timer() - model_load_start
    ...
    for file in os.listdir(directory):
        ...
        if filename.endswith(".wav"):
            ...
            if fs != 16000:
                ...
                fs, audio = convert_samplerate(fn2)
                audio_length = fin.getnframes() * (1 / 16000)
                fin.close()
            else:
                audio = np.frombuffer(fin.readframes(fin.getnframes()), np.int16)
            ...
            if tts_choice == 0:
                ...
                save_path = f'quick_start/__input_{ans[:10]}.wav'
